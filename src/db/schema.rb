...
ActiveRecord::Schema.define(version: 2022_12_18_121339) do
  ...
  create_table "formation_posts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.text "body"
    t.string "opponent"
    t.decimal "offenseid", precision: 10
    t.decimal "deffenseid", precision: 10
  ...
  create_table "image_blobs", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "uniforms", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "user_id"
    t.integer "formation_post_id"
